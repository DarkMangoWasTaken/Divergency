...
{
    public class LivingRageParticle2 : Particle
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color lightColor)
        {
            ...
            Texture2D tex3 = Request<Texture2D>("DivergencyMod/Dusts/Particles/LivingRageParticle2").Value;
            ...
            spriteBatch.Draw(tex3, Bottom - Main.screenPosition, tex3.AnimationFrame(ref frameCount, ref frameTick, 1, 23, true), color, 0, new Vector2(200f, 150f) * 0.5f, 0.7f * Scale, effect, 0f);
            spriteBatch.Draw(tex3, Bottom - Main.screenPosition, tex3.AnimationFrame(ref frameCount, ref frameTick, 1, 23, true), color, 0, new Vector2(200f, 150f) * 0.5f, 0.7f * Scale, effect, 0f);
