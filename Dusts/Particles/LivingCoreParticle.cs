...
{
    public class LivingCoreParticle : Particle
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color lightColor)
        {
            ...
            Texture2D tex2 = Request<Texture2D>("DivergencyMod/Dusts/Particles/LivingCoreParticle").Value;
            ...
            spriteBatch.Draw(tex2, position - Main.screenPosition, new Rectangle(0, 0, tex2.Width, tex2.Height), color, ai[0].InRadians().AngleLerp((ai[0] * 180f).InRadians(), (120f - timeLeft) / 120f), new Vector2(tex2.Width / 2f, tex2.Height / 2f), 0.2f * scale, SpriteEffects.None, 0f);
