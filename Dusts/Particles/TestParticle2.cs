...
namespace DivergencyMod.Dusts.Particles
{
    public class TestParticle2 : Particle
    {
        ...
        {
            Texture2D circle = ModContent.Request<Texture2D>("DivergencyMod/Dusts/Particles/Circle").Value;
            Texture2D ember = ModContent.Request<Texture2D>("DivergencyMod/Dusts/Particles/EmberParticle").Value;
            Texture2D glow = ModContent.Request<Texture2D>("DivergencyMod/Dusts/Particles/SoftGlow").Value;
