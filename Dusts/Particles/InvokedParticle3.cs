...
{
    public class InvokedParticle3 : Particle
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color lightColor)
        {
            ...
            spriteBatch.Draw(tex3, position - Main.screenPosition, new Rectangle(0, 0, tex3.Width, tex3.Height), color, velocity.ToRotation(), new Vector2(tex3.Width / 2f, tex3.Height / 2f), 0.05f * scale, SpriteEffects.None, 0f);
