...
{
    public class Telegraph : Particle
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color lightColor)
        {
            ...
            Texture2D tex2 = Request<Texture2D>("DivergencyMod/Dusts/Particles/Telegraph").Value;
            ...
            spriteBatch.Draw(tex2, position - Main.screenPosition, new Rectangle(0, 0, tex2.Width, tex2.Height), color,velocity.ToRotation()+ MathHelper.PiOver2, new Vector2(tex2.Width / 2f, tex2.Height / 2f), 0.7f * scale, SpriteEffects.None, 0f);
