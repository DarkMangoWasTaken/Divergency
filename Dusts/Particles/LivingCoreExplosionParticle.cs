...
namespace DivergencyMod.Dusts.Particles
{
    public class LivingCoreExplosionParticle : Particle
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 drawPos, Color lightColor)
        {
            ...
            spriteBatch.Draw(tex3, position - Main.screenPosition, new Rectangle(0, 0, tex3.Width, tex3.Height), color, rotation,  new Vector2(tex3.Width / 2f, tex3.Height / 2f), 1.2f * Scale, SpriteEffects.None, 0f);
            return false;
        }
    }
}