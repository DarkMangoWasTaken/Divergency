...
{
    public class LivingAura : Particle
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color lightColor)
        {
            ...
            Texture2D tex3 = Request<Texture2D>("DivergencyMod/Dusts/Particles/LivingAura").Value;
            ...
            spriteBatch.Draw(tex3, Bottom - Main.screenPosition, tex3.AnimationFrame(ref frameCount, ref frameTick, 1, 28, true), color, 0, new Vector2(150f, 92f) * 0.5f, 0.7f * Scale, effect, 0f);
