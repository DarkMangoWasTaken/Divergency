...
{
    public class CoreDoublerUpRightTile : ModTile
    {
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            WorldGen.PlaceTile(i, j, ModContent.TileType<CoreDoublerRightDownTile>());
            //if (!ChangeTexture)
            //   ChangeTexture = true;
            //else
            //   ChangeTexture = false;
        ...
        {
            Texture2D tex = ModContent.Request<Texture2D>("DivergencyMod/Tiles/LivingTree/CoreDoublerUpRightTile").Value;
            Texture2D tex2 = ModContent.Request<Texture2D>("DivergencyMod/Tiles/LivingTree/CoreDoublerUpRightTile").Value;
            Tile tile = Framing.GetTileSafely(i, j);
    ...
    internal class CoreDoublerUpRight : ModItem
    {
        public override string Texture => "DivergencyMod/Tiles/LivingTree/CoreDoublerUpRightTile";
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<CoreDoublerUpRightTile>();
        }
    }
}
