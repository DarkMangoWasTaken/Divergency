...
namespace DivergencyMod.Tiles.LivingTree
{
    public class CoreMirrorTileUp : ModTile
    {
        ...
        {
            Texture2D tex = ModContent.Request<Texture2D>("DivergencyMod/Tiles/LivingTree/CoreMirrorTileUp").Value;
            Texture2D tex2 = ModContent.Request<Texture2D>("DivergencyMod/Tiles/LivingTree/CoreMirrorTileUp").Value;
            Tile tile = Framing.GetTileSafely(i, j);
    ...
    {
        public override string Texture => "DivergencyMod/Tiles/LivingTree/CoreMirrorTileUp";
