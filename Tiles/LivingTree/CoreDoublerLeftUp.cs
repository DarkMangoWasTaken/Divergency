...
{
    public class CoreDoublerLeftUpTile : ModTile
    {
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            WorldGen.PlaceTile(i, j, ModContent.TileType<CoreDoublerUpRightTile>());
            //if (!ChangeTexture)
            //   ChangeTexture = true;
            //else
            //   ChangeTexture = false;
        ...
        {
            Texture2D tex = ModContent.Request<Texture2D>("DivergencyMod/Tiles/LivingTree/CoreDoublerLeftUpTile").Value;
            Texture2D tex2 = ModContent.Request<Texture2D>("DivergencyMod/Tiles/LivingTree/CoreDoublerLeftUpTile").Value;
            Tile tile = Framing.GetTileSafely(i, j);
    ...
    internal class CoreDoublerLeftUp : ModItem
    {
        public override string Texture => "DivergencyMod/Tiles/LivingTree/CoreDoublerLeftUpTile";
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<CoreDoublerLeftUpTile>();
        }
    }
}
