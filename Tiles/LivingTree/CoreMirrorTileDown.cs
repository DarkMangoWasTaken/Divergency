...
{
    public class CoreMirrorTileDown : ModTile
    {
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            WorldGen.PlaceTile(i, j, ModContent.TileType<CoreMirrorTileLeft>());
            //if (!ChangeTexture)
            //   ChangeTexture = true;
            //else
            //   ChangeTexture = false;
        ...
        {
            Texture2D tex = ModContent.Request<Texture2D>("DivergencyMod/Tiles/LivingTree/CoreMirrorTileDown").Value;
            Texture2D tex2 = ModContent.Request<Texture2D>("DivergencyMod/Tiles/LivingTree/CoreMirrorTileDown").Value;
            Tile tile = Framing.GetTileSafely(i, j);
    ...
    internal class CoreMirrorDown : ModItem
    {
        public override string Texture => "DivergencyMod/Tiles/LivingTree/CoreMirrorTileDown";
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<CoreMirrorTileDown>();
        }
    }
}
