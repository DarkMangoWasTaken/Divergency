...
{
    public class CoreMirrorTileRight : ModTile
    {
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            WorldGen.PlaceTile(i, j, ModContent.TileType<CoreMirrorTileDown>());
            //if (!ChangeTexture)
            //   ChangeTexture = true;
            //else
            //   ChangeTexture = false;
        ...
        {
            Texture2D tex = ModContent.Request<Texture2D>("DivergencyMod/Tiles/LivingTree/CoreMirrorTileRight").Value;
            Texture2D tex2 = ModContent.Request<Texture2D>("DivergencyMod/Tiles/LivingTree/CoreMirrorTileRight").Value;
            Tile tile = Framing.GetTileSafely(i, j);
    ...
    internal class CoreMirrorRight : ModItem
    {
        public override string Texture => "DivergencyMod/Tiles/LivingTree/CoreMirrorTileRight";
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<CoreMirrorTileRight>();
        }
    }
}
