...
{
    public class CoreMirrorTileLeft : ModTile
    {
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            WorldGen.PlaceTile(i, j, ModContent.TileType<CoreMirrorTileUp>());
            //if (!ChangeTexture)
            //   ChangeTexture = true;
            //else
            //   ChangeTexture = false;
        ...
        {
            Texture2D tex = ModContent.Request<Texture2D>("DivergencyMod/Tiles/LivingTree/CoreMirrorTileLeft").Value;
            Texture2D tex2 = ModContent.Request<Texture2D>("DivergencyMod/Tiles/LivingTree/CoreMirrorTileLeft").Value;
            Tile tile = Framing.GetTileSafely(i, j);
    ...
    internal class CoreMirrorLeft : ModItem
    {
        public override string Texture => "DivergencyMod/Tiles/LivingTree/CoreMirrorTileLeft";
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<CoreMirrorTileLeft>();
        }
    }
}
