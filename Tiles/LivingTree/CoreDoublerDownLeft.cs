...
{
    public class CoreDoublerDownLeftTile : ModTile
    {
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            WorldGen.PlaceTile(i, j, ModContent.TileType<CoreDoublerLeftUpTile>());
            //if (!ChangeTexture)
            //   ChangeTexture = true;
            //else
            //   ChangeTexture = false;
        ...
        {
            Texture2D tex = ModContent.Request<Texture2D>("DivergencyMod/Tiles/LivingTree/CoreDoublerDownLeftTile").Value;
            Texture2D tex2 = ModContent.Request<Texture2D>("DivergencyMod/Tiles/LivingTree/CoreDoublerDownLeftTile").Value;
            Tile tile = Framing.GetTileSafely(i, j);
    ...
    internal class CoreDoublerDownLeft : ModItem
    {
        public override string Texture => "DivergencyMod/Tiles/LivingTree/CoreDoublerDownLeftTile";
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<CoreDoublerDownLeftTile>();
        }
    }
}
